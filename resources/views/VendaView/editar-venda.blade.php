        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{URL('atualizar/venda/')}}">
                            @csrf
                                    ...
                                    <div class="form-group{{ $errors->has('pedido_id') ? ' has-danger' : '' }}">
                                        <select id="pedido_id" class="form-control{{ $errors->has('pedido_id') ? ' is-invalid' : '' }}" name="pedido_id" required autofocus>
                                            ...
                                            @foreach ($pedidos as $pedido)
                                                <option value="{{$pedido->id}}" {{ $venda->pedido_id == $pedido->id ? 'selected' : ''}} required autofocus  >{{$pedido->id}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group{{ $errors->has('formapagamento_id') ? ' has-danger' : '' }}">
                                        <select id="formapagamento_id" class="form-control{{ $errors->has('formapagamento_id') ? ' is-invalid' : '' }}"  name="formapagamento_id" required autofocus>
                                            ...
                                            @foreach ($formapagamentos as $formapagamento)
                                                <option value="{{$formapagamento->id}}" {{ $venda->formapagamento_id == $formapagamento->id ? 'selected' : ''}} required autofocus  >{{$formapagamento->descricao}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input id="data_pagamento" type="date" class="form-control" name="data_pagamento" value="{{$venda->data_pagamento}}" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input id="data_venda" type="date" class="form-control" name="data_venda" value="{{$venda->data_venda}}" >
